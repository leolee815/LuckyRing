class GameEndView extends egret.Sprite {
    public constructor() {
        super();
        this.addEventListener(egret.Event.ADDED_TO_STAGE, this.onAddToStage, this);
    }

    public ruleBtn:egret.Sprite;
    public replayBtn:egret.Sprite;
    public shareBtn:egret.Sprite;
    public followBtn:egret.Sprite;
    public shareView:egret.Bitmap;
    public texttop:egret.TextField = new egret.TextField;
    public textMon:egret.TextField = new egret.TextField;
    public textMiddle:egret.TextField = new egret.TextField;
    public textMiddle1:egret.TextField = new egret.TextField;
    public gameDiv;
    public myImg;

    private onAddToStage(evt:egret.Event):void {
        var gameEndView:egret.Bitmap = new egret.Bitmap();
...
/*
    ...
    private createBtn (x:number,y:number,width:number,height:number,text:string,paddin:number) {

        var paddingX = paddin || 15;
        var containBtn:egret.Sprite = new egret.Sprite();
        ...
        var gameBtn:egret.TextField = new egret.TextField();
        gameBtn.text = text;
